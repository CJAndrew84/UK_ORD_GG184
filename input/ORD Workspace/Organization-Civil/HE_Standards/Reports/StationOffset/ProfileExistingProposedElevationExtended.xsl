...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:cif="cif">
                ...
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:for-each select="InRoads">
                            <center>
                                <h2 lang="en">Profile Existing and Proposed Elevations Report Extended</h2>
                                <p lang="en">
                                    ...
                                    <xsl:for-each select="HorizontalAlignment[StationOffsetPoints]">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th class="underline" lang="en">Existing<br/>Elevation</th>
                                                <th class="underline" lang="en">Proposed<br/>Elevation</th>
                                                <th class="underline" lang="en">Cut/Fill<br/>Depth</th>
                                            </tr>
                                        </thead>
                                        <tbody>
    ...
    <xsl:template name="StyleSheetHelp">
        <div class="section1">
            ...
            <p class="normal1" lang="en">
                You must include <em>Horizontal Alignment</em> on the <em>General</em>
