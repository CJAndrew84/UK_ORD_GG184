    ...
    <xsl:template match="/">
        ...
        <html>
            <head>
                ...
                <title lang="en">Chainage and Offset with Instantaneous Radii Report</title>
            </head>
            <body>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:for-each select="InRoads">
                            <center>
                                <h2 lang="en">Chainage and Offset with Instantaneous Radii Report</h2>
                                <p lang="en">
                                    ...
                                    <xsl:for-each select="HorizontalAlignment[StationOffsetPoints]">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td align="left" colspan="5" valign="bottom"><xsl:value-of select="@name"/></td>
                                            </tr>
                                            <tr>
                                                <th align="right" colspan="2" lang="en">Alignment Description:&#xa0;</th>
                                                <td align="left" colspan="5"><xsl:value-of select="@description"/></td>
                                            </tr>
                                            <tr>
                                                <th align="right" colspan="2" lang="en">Alignment Style:&#xa0;</th>
                                                <td align="left" colspan="5"><xsl:value-of select="@style"/></td>
                                            </tr>
                                            <tr>
                                                <th class="underline" lang="en">Point Type</th>
                                                <th align="right" class="underline" lang="en">Chainage</th>
                                                <th align="right" class="underline" lang="en">Offset</th>
                                                ...
                                                <th align="right" class="underline" lang="en">Radius</th>
                                            </tr>
                                            <xsl:for-each select="StationOffsetPoints/StationOffsetPoint">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <xsl:value-of select="cif:distanceFormat(number(centerLinePoint/point/@offset))"/>
                                                    </td>
                                                    <td align="right">
    ...
    <xsl:template name="StyleSheetHelp">
        <div class="section1">
            ...
            <p class="normal1" lang="en">
                You must create station offset points for this report by selecting <em>Tools &gt; XML 
                Reports &gt; Station Offset</em>.
            </p>
            <p class="normal1" lang="en">
