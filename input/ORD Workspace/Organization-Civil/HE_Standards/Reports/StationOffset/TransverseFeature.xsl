    ...
    <xsl:template match="/">
        ...
        <html>
            <head>
                ...
                <title lang="en">Transverse Feature Report</title>
            </head>
            <body>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:for-each select="InRoads">
                            <center>
                                <h2 lang="en">Transverse Feature Report</h2>
                                <p lang="en">
                            ...
                            <xsl:for-each select="GeometryProject">
                                ...
                                <table class="margin" cellpadding="2" width="80%">
                                    <thead>
                                        <tr>
                                            <th class="underline" lang="en">Feature</th>
                                    ...
                                    <tbody>
                                        <xsl:for-each select="//StationOffsetPoint">
                                            ...
                                            <tr>
                                                <td class="sidepad"><xsl:value-of select="@offsetAlignmentName"/></td>
