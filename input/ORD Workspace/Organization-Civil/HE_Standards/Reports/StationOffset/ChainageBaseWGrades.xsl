                            ...
                            <xsl:for-each select="GeometryProject">
                                ...
                                <xsl:for-each select="*/StationOffsetPoints">
                                    <table class="margin" cellpadding="2" width="100%">
                                        <thead>
                                            <tr>
                                                <th colspan="7" lang="en">- - - - - - - - Baseline Alignment - - - - - - -</th>
                                                <th>&#xa0;</th>
                                                <th colspan="6" lang="en">- - - - - - - - Offset Alignment - - - - - - - -</th>
                                            </tr>
                                            <tr>
                                                ...
                                                <th class="underline" lang="en" valign="bottom">Gradient</th>
                                        ...
                                        <tbody>
                                            <xsl:for-each select="StationOffsetPoint">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <xsl:value-of select="cif:gradeFormat(number(offsetLinePoint/@instantaneousGrade))"/>
                                                    </td>
                                                </tr>
                                            </xsl:for-each>
                                        </tbody>
