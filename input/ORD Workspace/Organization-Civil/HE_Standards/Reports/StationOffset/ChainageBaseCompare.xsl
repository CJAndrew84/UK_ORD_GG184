    ...
    <xsl:template match="/">
        ...
        <html>
            <head>
                ...
                <title lang="en">Station Base Report</title>
            </head>
            <body>
                <xsl:choose>
                        ...
                        <xsl:for-each select="InRoads">
                            ...
                            <xsl:for-each select="GeometryProject">
                                ...
                                <xsl:for-each select="*/StationOffsetPoints">
                                    <table class="margin" cellspacing="2" width="100%">
                                        <thead>
                                            <tr>
    ...
    <xsl:template name="StyleSheetHelp">
        <div class="section1">
            ...
            <p class="normal1" lang="en">
                This report displays non-zero offsets in red, facilitating comparison of two similar
                alignments.
            </p>
            <p class="normal1" lang="en">
