    ...
    <xsl:template match="/">
        ...
        <html>
            <head>
                ...
                <title lang="en">Survey Point Feature Report</title>
            </head>
            <body>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:for-each select="InRoads">
                            <center>
                                <!-- Report Title -->
                                <h2 lang="en">Survey Point Feature Report</h2>
                                <p lang="en">
                            ...
                            <xsl:for-each select="SurveyFieldbook">
                                ...
                                <hr />
                                <!-- Cogo Point Data -->
                                <xsl:for-each select="SurveyPointList">
                                        ...
                                        <tbody>
                                            <xsl:for-each select="SurveyPoint">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><xsl:value-of select="cif:ordinateFormat(number(@easting))"/></td>
                                                </tr>
                                                <tr>
                                                    <th align="right" lang="en">Y:&#xa0; </th>
                                                    <td><xsl:value-of select="cif:ordinateFormat(number(@northing))"/></td>
                                                </tr>
                                                <tr>
                                                    <th align="right" lang="en">Elevation:&#xa0; </th>
                                                    <td><xsl:value-of select="cif:ordinateFormat(number(@elevation))"/></td>
                                                </tr>
                                                <tr>
