...
<xsl:param select="cif:xslRootDirectory" name="xslRootDirectory"/>
    <!-- Cogo Points with Extended Description Report -->
    <xsl:template match="/">
        ...
        <html>
            <head>
                ...
                <title lang="en">Survey Control Point Report</title>
            </head>
            <body>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:for-each select="InRoads">
                            <center>
                                <!-- Report Title -->
                                <h2 lang="en">Survey Control Point Report</h2>
                                <p lang="en">
                            ...
                            <xsl:for-each select="SurveyFieldbook">
                                ...
                                <table class="margin" cellpadding="2" cellspacing="2" width="80%">
                                    <thead style="display:table-header-group">
                                        <tr>
                                            <th class="underline" lang="en" align="left">Control<br/>Point<br/>Name</th>
                                            ...
                                            <th class="underline" lang="en" align="right">Std.<br/>Error<br/>X</th>
                                            <th class="underline" lang="en" align="right">Std.<br/>Error<br/>Y</th>
                                            <th class="underline" lang="en" align="right">Std.<br/>Error<br/>Z</th>
                                    ...
                                    <tbody>
                                    <xsl:for-each select="SurveyControlPointList">
                                        <tbody>
                                            <xsl:for-each select="SurveyControlPoint">
                                                <tr>
                                                    <td align="left">
                                                    ...
                                                    <td align="right">
                                                        <xsl:value-of select="cif:distanceFormat(number(@standardErrorX))"/>
                                                    </td>
                                                    <td align="right">
                                                        <xsl:value-of select="cif:distanceFormat(number(@standardErrorY))"/>
                                                    </td>
                                                    <td align="right">
                                                        <xsl:value-of select="cif:distanceFormat(number(@standardErrorZ))"/>
                                                    </td>
                                                    <td align="left">
    ...
    <xsl:template name="StyleSheetHelp">
        <div class="section1">
            ...
            <p class="normal1" lang="en">
                     You must have at least one field book in Project Explorer (Survey) which contains a minimum of one survey control point to get results from this report.
	</p>

<p class="normal1">For best results, run the report from the Details panel.  Select All Control Points in Project Explorer, which populates the Details panel.  Highlight the row(s) to be included in the report, right click, and select Report on Selected Items.
</p>
<p class="normal1">Running the report from the generic survey report tool, or right clicking on a graphic only reports on the individually selected element. 
            ...
            <p class="normal1">Once the Civil Report Browser is open, you can select any other Survey Control Points report, which utilizes the same data as the original report.</p>
