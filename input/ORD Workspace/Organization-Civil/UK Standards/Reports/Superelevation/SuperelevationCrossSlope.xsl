    ...
    <xsl:template match="/">
        ...
        <html>
            <head>
                ...
                <title lang="en">Superelevation Cross Slope Report</title>
            </head>
            <body>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:for-each select="InRoads">
                            <center>
                                <!-- Report Title -->
                                <h2 lang="en">Superelevation Cross Slope Report</h2>
                                <p lang="en">
                                        ...
                                        <table class="margin" cellpadding="3" cellspacing="2" width="95%">
                                            <thead style="display:table-header-group">
                                                <tr>
                                                    ...
                                                    <th class="underline" lang="en" align="center">Width</th>
                                                    <th class="underline" lang="en" align="center">Drop/Rise</th>
