    ...
    <xsl:template match="/">
        ...
        <html>
            <head>
                ...
                <title lang="en">Minimum Clearance Report</title>
            </head>
            <body>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:for-each select="InRoads">
                            <center>
                                <!-- Report Title -->
                                <h2 lang="en">Minimum Clearance Report</h2>
                                <p lang="en">
                            ...
                            <xsl:for-each select="GeometryProject">
                                ...
                                <table class="margin" cellpadding="2" width="90%">
                                    <thead style="display:table-header-group">
                                        <tr>
                                            <th class="underline" lang="en" rowspan="2" valign="bottom">Clearance<br />Alignment</th>
                                            <th class="underline" lang="en" rowspan="2" valign="bottom">Offset<br />Point</th>
                                            <th class="underline" lang="en" rowspan="2" valign="bottom">Baseline<br />Chainage</th>
                                            <th class="underline" lang="en" rowspan="2" valign="bottom">Minimum<br/>Left Offset</th>
                                            <th class="underline" lang="en" rowspan="2" valign="bottom">Minimum<br/>Right Offset</th>
                                            <th lang="en" colspan="3">- - - - - - Offset Point - - - - - -</th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody>
                                        <xsl:for-each select="$uniqueClearanceAlignments">
                                            <xsl:for-each select="//ClearancePoint[@clearanceAlignmentName = current() and @firstOffset &lt; 0]">
                                                <xsl:sort select="@firstOffset" data-type="number"/>
                                                <xsl:if test="position() = last()">
                                                    <tr>
                                                        <td align="left">
                                                            <xsl:value-of select="@clearanceAlignmentName"/>
                                                        </td>
                                                        <td align="center">
                                        ...
                                        <xsl:if test="//ClearancePoint[@origin = 'point']">
                                            <xsl:for-each select="//ClearancePoint[@origin = 'point' and @firstOffset &lt; 0]">
                                                <xsl:sort select="@firstOffset" data-type="number"/>
                                                <xsl:if test="position() = last()">
                                                    <tr>
                                                        <td align="center">---</td>
