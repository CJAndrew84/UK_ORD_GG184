...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:cif="cif">
    ...
    <xsl:template match="HorizontalLine">
        ...
        <tr>
            ...
            <td>&#xa0;</td>
            <td align="right">
			   <xsl:value-of select="cif:ordinateFormat(number(End/station/@externalStation) - number(Start/station/@externalStation))"/>
			</td>
            <td>&#xa0;</td>
            <td>&#xa0;</td>
            <td>&#xa0;</td>
    ...
    <xsl:template match="HorizontalCircle">
        ...
        <tr>
			...
			<td align="center" lang="en">
				<xsl:if test="@rotationDirection='cw'">Right Hand</xsl:if>
				<xsl:if test="@rotationDirection = 'ccw'">Left Hand</xsl:if>
			</td>
            <td>&#xa0;</td>
            <td>&#xa0;</td>
        </tr>
