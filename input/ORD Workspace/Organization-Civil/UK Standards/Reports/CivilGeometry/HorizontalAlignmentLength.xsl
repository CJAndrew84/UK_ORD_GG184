...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:cif="cif">
    ...
    <!-- Horizontal Alignment Data Report -->
    <xsl:template match="/">
        ...
        <html>
            <head>
                ...
                <title lang="en">Horizontal Alignment Length Report</title>
            </head>
            <body>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:for-each select="InRoads">
                            <center>
                                <!-- Report Title -->
                                <h2 lang="en">Horizontal Alignment Length Report</h2>
                                <p lang="en">
                            ...
                            <xsl:for-each select="GeometryProject">
                                <table class="margin" cellpadding="2" width="90%">
                                  ...
                                  <hr/>
                                <table class="margin" cellpadding="2" width="40%">
                                    <tr>
                                        <th class="underline" lang="en" valign="bottom">Alignment Name</th>
                                        <th class="underline" lang="en" valign="bottom">Length</th>
                                    </tr>
                                    <xsl:for-each select="HorizontalAlignment">
                                        <tr>
                                            <td class="sidepad" lang="en" valign="bottom"><xsl:value-of select="@name"/></td>
                                            <td class="sidepad" align="right" valign="bottom">
                                                <xsl:value-of select="cif:distanceFormat(number(sum(HorizontalElements/*/@length)))"/>
                                            </td>
                                        </tr>
                                        <tr><td colspan="2" style="line-height:10%;">&#xa0;</td></tr>
                                    </xsl:for-each>
                                </table>
                            </xsl:for-each>
                        </xsl:for-each>
