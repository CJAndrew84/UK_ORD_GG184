                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="sidepad" align="right">
                                                                                    ...
                                                                                    <xsl:choose>
                                                                                        ...
                                                                                        <xsl:when test="../../../Points/Point[@name = current()/@name]/Constraint[2]/@type = 'None'">
                                                                                            &#xa0;<br/>&#xa0;
                                                                                        </xsl:when>
                                                                                        <xsl:otherwise>
                                                                                            <xsl:value-of select="cif:distanceFormat(number(../../../Points/Point[@name = current()/@name]/Constraint[2]/@value))"/><br/>
                                                                                        </xsl:otherwise>
                                                                                    </xsl:choose>
                                                                                </td>
                                                                                <td>
