    ...
    <xsl:template match="/">
        ...
        <html>
            <head>
                ...
                <title lang="en">Radial Stakeout Report</title>
            </head>
            <body>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:for-each select="InRoads">
                            <center>
                                <!-- Report Title -->
                                <h2 lang="en">Radial Stakeout Report</h2>
                                <p lang="en">
                                ...
                                <table cellpadding="2" cellspacing="2" class="margin" width="70%">
                                    <tbody>
                                        <xsl:for-each select="HorizontalAlignment[StakeoutPoints/StakeoutPoint]">
                                            ...
                                            <tr>
                                                <th class="underline" lang="en">BS</th>
                                                <th class="underline" lang="en">OC</th>
                                                <th class="underline" lang="en">FS</th>
                                                <th class="underline" lang="en">Angle Right</th>
    ...
    <xsl:template name="StyleSheetHelp">
        <div class="section1">
            ...
            <p class="normal1" lang="en">
                ...
                <em>General</em> leaf in the <em>From</em> group.<br/><br style="line-height:50%"/>
                <strong>Note:&#xa0;</strong> A backsight and foresight point are required for a complete 
                report.
            </p>
            <p class="normal1" lang="en">
