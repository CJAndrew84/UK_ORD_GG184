    ...
    <xsl:template match="/">
        ...
        <html>
            <head>
                ...
                <title lang="en">Chainage Base Vertical Clearance Report</title>
            </head>
            <body>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:for-each select="InRoads">
                            <center>
                                <h2 lang="en">Chainage Base Vertical Clearance Report</h2>
                                <p lang="en">
                            ...
                            <xsl:for-each select="GeometryProject">
                                <table class="margin" cellpadding="2" width="90%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th align="right">Baseline (Active) Alignment:&#xa0; </th>
                                        ...
                                        <thead>
                                            <tr>
                                                <th class="underline" lang="en" valign="bottom">
                                                    Active Alignment<br/>Station<br/>
                                                    (<xsl:value-of select="../../../@name"/>)
                                                </th>
                                                <th class="underline" lang="en" valign="bottom">Type</th>
                                                <th class="underline" lang="en">
                                                    Perpendicular Distance<br/>from Active Alignment<br/>to Specified Alignment
                                                    <br/>Offset is <xsl:value-of select="cif:distanceFormat(number(../@secondOffset))"/>
                                                    <br/>(<xsl:value-of select="."/>)
                                                </th>
                                                <th class="underline" lang="en" valign="bottom">
                                                    Vertical Clearance<br/>to <xsl:value-of select="."/>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
