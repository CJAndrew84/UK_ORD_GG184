    ...
    <xsl:template match="/">
        ...
        <html>
            <head>
                ...
                <title lang="en">Chainage Offset with Smoothing Radius Report</title>
            </head>
            <body>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:for-each select="InRoads">
                            <center>
                                <h2 lang="en">Chainage Offset with Smoothing Radius Report</h2>
                                <p lang="en">
                                    ...
                                    <table class="margin" cellpadding="2" width="100%">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th class="underline" lang="en" valign="bottom">Instantaneous Radius</th>
                                                <th>&#xa0;</th>
                                                <th class="underline" lang="en" valign="bottom">Chainage</th>
                                                <th class="underline" lang="en" valign="bottom">Type</th>
                                                <th class="underline" lang="en" valign="bottom">Radial Direction</th>
                                        ...
                                        <tbody>
                                            <xsl:for-each select="StationOffsetPoint">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <xsl:value-of select="cif:distanceFormat(number(offsetLinePoint/@smoothingRadius))"/>
                                                    </td>
                                                </tr>
                                            </xsl:for-each>
                                        </tbody>
    ...
    <xsl:template name="StyleSheetHelp">
        <div class="section1">
            ...
            <p class="normal1" lang="en">
                ...
                </em>.  You must invoke the command with CTRL when clicking the Station Offset Report.
            </p>
            <p class="normal1" lang="en">
            ...
            <p class="normal1" lang="en">
                You must choose at least one option on the <em>Include</em> leaf (<em>
                    ...
                    Points
                </em> or <em>Interval</em>.  You must include the Smoothing option, which will appear
                when you select the command with the CTRL.)
            </p>
